...
public class ServiceDao {
	...
	public String insertDataCmd(GpsTracker gps,String imei,String num,String battery,Compte c,String fact){
	...
	String dateString = format.format( new Date());
		...
		nameValue.add(new BasicNameValuePair("username", c.getLogin()));
		nameValue.add(new BasicNameValuePair("password", c.getPassword()));
		nameValue.add(new BasicNameValuePair("cmd", fact));
		
		Log.e("data envoyer",nameValue.toString());
		
		String url2 = URL.URL+"gpsservicecmd.php";
	...
	public String insertDataIntrv(GpsTracker gps,String imei,String num,String battery,Compte c,String fact){
	...
	String dateString = format.format( new Date());
		...
		nameValue.add(new BasicNameValuePair("username", c.getLogin()));
		nameValue.add(new BasicNameValuePair("password", c.getPassword()));
		nameValue.add(new BasicNameValuePair("brd", fact));
		
		Log.e("data envoyer",nameValue.toString());
		
		String url2 = URL.URL+"gpsservicebordereau.php";
